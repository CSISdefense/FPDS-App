...
ui <- fluidPage(
      ...
      fluidRow(
          ...
          column(3, align = 'center',
                  ...
                  selectizeInput("Customer","Customer", customers,
                              multiple = TRUE,
                              #selectize = TRUE,
                              selected = customers,
                              options = list(plugins = 
                 ...
                 selectInput('Cat', 'Category', c("Products", "Services", "R&D"), multiple=TRUE, selectize=FALSE, size = 2), 
                  br(),
...
FullData$Customer[FullData$Customer == "MilitaryHealth"] <- "Other"  
...
plotsettings <- reactive({
      p <- ggplot(data = dataset(),
            ...
            #coll: Added title 
            ggtitle("Share of Contract Obligations by Vendor Size") + 
